      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <motion.div
            ...
            className="bg-white p-6 rounded-[40px] shadow-2xl"
          >
          ...
          >
            ...
            <p className="text-gray-600 text-lg leading-relaxed mt-8">
              ...
              Premium quality toy product
              with modern design,
              smooth finishing and
              perfect gift choice for kids.
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    >
                      ...
                      <button className="mt-5 w-full bg-black text-white py-3 rounded-2xl font-semibold hover:scale-105 transition">
                        View Product
                      </button>
